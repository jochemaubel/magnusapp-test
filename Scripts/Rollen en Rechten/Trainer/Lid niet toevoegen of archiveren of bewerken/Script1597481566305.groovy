...
WebUI.verifyElementNotPresent(findTestObject('Algemeen/Archiveren item in lijst'), 0)

WebUI.verifyElementNotPresent(findTestObject('Algemeen/Aanpassen item in lijst'), 0)
