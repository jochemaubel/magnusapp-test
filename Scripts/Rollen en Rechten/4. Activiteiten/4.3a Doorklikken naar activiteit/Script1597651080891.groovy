...
WebUI.verifyElementPresent(findTestObject('1. Menu/2. Club/Registratie'), 0)

WebUI.click(findTestObject('0. Algemeen/Back Button'))

WebUI.click(findTestObject('4. Activiteiten/TEST competitie'))

WebUI.verifyElementPresent(findTestObject('4. Activiteiten/TEST competitie pagina'), 0)
