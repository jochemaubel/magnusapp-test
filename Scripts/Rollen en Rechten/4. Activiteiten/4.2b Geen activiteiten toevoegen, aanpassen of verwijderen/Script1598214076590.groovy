...
WebUI.verifyElementNotPresent(findTestObject('4. Activiteiten/Bewerk TEST clubavond vrijdag'), 0)

WebUI.verifyElementNotPresent(findTestObject('4. Activiteiten/Verwijder TEST clubavond vrijdag'), 0)
