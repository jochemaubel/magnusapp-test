...
WebUI.verifyElementNotPresent(findTestObject('0. Algemeen/Archiveren item in lijst'), 0)

WebUI.verifyElementNotPresent(findTestObject('0. Algemeen/Aanpassen item in lijst'), 0)
