...
WebUI.click(findTestObject('3. Groepen/Modal ListItem Bessel Bakker'))

WebUI.click(findTestObject('3. Groepen/Tab Begeleiders of Trainers'))

WebUI.click(findTestObject('3. Groepen/Modal ListItem Donald Duck'))
